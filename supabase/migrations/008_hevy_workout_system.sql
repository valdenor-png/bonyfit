...
('Elevação Lateral', 'Ombro', 'Halter', ARRAY[], 'Até altura dos ombros. Não balance.', 240, false),
('Elevação Frontal', 'Ombro', 'Halter', ARRAY[], 'Alternado ou simultâneo.', 240, false),
...
('Elevação Lateral no Cabo', 'Ombro', 'Cabo', ARRAY[], 'Tensão constante.', 240, false),

-- BÍCEPS (8)
('Rosca Direta com Barra', 'Bíceps', 'Barra', ARRAY[], 'Cotovelos fixos. Contração no topo.', 280, false),
('Rosca Alternada com Halter', 'Bíceps', 'Halter', ARRAY[], 'Supinação no topo.', 280, false),
('Rosca Scott', 'Bíceps', 'Barra', ARRAY[], 'Apoio no banco Scott.', 240, false),
('Rosca Martelo', 'Bíceps', 'Halter', ARRAY['Antebraço'], 'Pegada neutra. Braquial.', 240, false),
('Rosca Concentrada', 'Bíceps', 'Halter', ARRAY[], 'Cotovelo na coxa. Isolar.', 200, false),
('Rosca no Cabo', 'Bíceps', 'Cabo', ARRAY[], 'Tensão constante.', 240, false),
('Rosca 21', 'Bíceps', 'Barra', ARRAY[], '7 baixo + 7 alto + 7 completas.', 200, false),
('Rosca Inversa', 'Bíceps', 'Barra', ARRAY['Antebraço'], 'Pegada pronada. Antebraço.', 200, false),

-- TRÍCEPS (8)
('Tríceps Pulley', 'Tríceps', 'Cabo', ARRAY[], 'Cotovelos fixos. Extensão completa.', 260, false),
('Tríceps Corda', 'Tríceps', 'Cabo', ARRAY[], 'Abra a corda no final.', 260, false),
('Tríceps Testa', 'Tríceps', 'Barra', ARRAY[], 'Cotovelos pro teto. Controle.', 280, false),
('Tríceps Francês', 'Tríceps', 'Halter', ARRAY[], 'Desça atrás da cabeça.', 280, false),
...
('Kickback com Halter', 'Tríceps', 'Halter', ARRAY[], 'Braço paralelo ao corpo.', 200, false),
('Extensão Overhead com Halter', 'Tríceps', 'Halter', ARRAY[], 'Segure um halter com as duas mãos.', 260, false),
...
('Cadeira Extensora', 'Perna', 'Máquina', ARRAY[], 'Extensão completa. Controle.', 240, false),
('Mesa Flexora', 'Perna', 'Máquina', ARRAY[], 'Posterior da coxa.', 240, false),
...
('Leg Curl Deitado', 'Perna', 'Máquina', ARRAY[], 'Posterior. Controle a descida.', 240, false),
('Adutora', 'Perna', 'Máquina', ARRAY[], 'Adutores. Controle.', 200, false),
('Abdutora', 'Perna', 'Máquina', ARRAY['Glúteo'], 'Abdutores e glúteo médio.', 200, false),
('Panturrilha em Pé', 'Perna', 'Máquina', ARRAY[], 'Amplitude total. Pausa no topo.', 200, false),
('Panturrilha Sentado', 'Perna', 'Máquina', ARRAY[], 'Sóleo. Amplitude total.', 200, false),
...
('Glúteo no Cabo', 'Glúteo', 'Cabo', ARRAY[], 'Coice. Controle.', 240, false),
('Agachamento Sumô', 'Glúteo', 'Halter', ARRAY['Perna'], 'Pés bem abertos. Ponta pra fora.', 300, false),
('Cadeira Abdutora Focada', 'Glúteo', 'Máquina', ARRAY[], 'Foco na contração do glúteo.', 200, false),
('Extensão de Quadril', 'Glúteo', 'Máquina', ARRAY['Perna'], 'Máquina ou graviton.', 240, false),

-- ABDÔMEN (8)
('Abdominal Crunch', 'Abdômen', 'Peso Corporal', ARRAY[], 'Contraia o core. Não puxe pescoço.', 200, false),
('Prancha', 'Abdômen', 'Peso Corporal', ARRAY['Lombar'], 'Corpo reto. Segure.', 180, false),
('Abdominal Infra', 'Abdômen', 'Peso Corporal', ARRAY[], 'Eleve quadril do chão.', 200, false),
('Abdominal Oblíquo', 'Abdômen', 'Peso Corporal', ARRAY[], 'Toque cotovelo no joelho oposto.', 200, false),
('Abdominal na Máquina', 'Abdômen', 'Máquina', ARRAY[], 'Carga controlada.', 200, false),
...
('Leg Raise Pendurado', 'Abdômen', 'Peso Corporal', ARRAY[], 'Eleve pernas na barra.', 200, false),

-- CARDIO (8)
('Esteira', 'Cardio', 'Máquina', ARRAY[], 'Ajustar velocidade e inclinação.', 0, false),
('Bicicleta Ergométrica', 'Cardio', 'Máquina', ARRAY[], 'Ajustar resistência.', 0, false),
('Elíptico', 'Cardio', 'Máquina', ARRAY[], 'Braços e pernas simultâneos.', 0, false),
('Transport', 'Cardio', 'Máquina', ARRAY[], 'Escada rolante.', 0, false),
